...
2. Make top-level project folder clear
  ...
  - If you use RStudioo Projects, you'll see `.Rproj` file
...
Files with chronological order? -> *Use the ISO 8601 standard for dates*
...
![](images/file_names_dates.png)

---

.center[![](images/iso_date_psa.png)]

---

# Plays well with default ordering

Files with logical order? -> Put something numeric first
