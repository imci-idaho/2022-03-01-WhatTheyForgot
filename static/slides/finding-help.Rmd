---
title: "Finding Help"
subtitle: "⚔<br/>to solve your R error"
...
* Sometimes you have to use backticks:  
```{r}
`[`
```
...
It checks CRAN, Bioconductor and GitHub!
...
Once you know the object class, you can search on methods built for that class. 
