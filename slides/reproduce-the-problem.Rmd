...
* there are many skilled R progammers out there: Stack Overflow, R4DS, RStudio Community, that other grad student who knows everything,...**
...
Next, paste the R-formatted data ([CTRL + V] on many systems) into an R source file. 
