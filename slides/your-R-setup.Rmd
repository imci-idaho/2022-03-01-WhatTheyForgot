...
* do not add this to git repository or make sure it ends up in *.gitignore*

---
#  .Rprofile

 
* An <u>R script</u> that runs every time R is opened or restarted
...
.First <- function() {
  cat("Welcome, High Priestress of R. 
...
.pull-right[
[let's go crazy exercise](exercises/exercise-2.html)
]
